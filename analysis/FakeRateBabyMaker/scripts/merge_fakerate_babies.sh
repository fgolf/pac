...
input_path=/hadoop/cms/store/user/gzevi/babies/fr/$tag
output_path=/nfs-7/userdata/gzevi/babies/fr/${tag}
...
#merge "\"$input_path/QCD_Pt_20_30_BCtoE_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1/*.root\""                $output_path/QCD_Pt_20_30_BCtoE_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1/merged_frbaby.root                >& logs/merge_fr_qcd15.log &
#merge "\"$input_path/QCD_Pt_30_80_BCtoE_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1/*.root\""                $output_path/QCD_Pt_30_80_BCtoE_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1/merged_frbaby.root                >& logs/merge_fr_qcd16.log &
#merge "\"$input_path/QCD_Pt_80_170_BCtoE_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1/*.root\""                $output_path/QCD_Pt_80_170_BCtoE_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1/merged_frbaby.root                >& logs/merge_fr_qcd17.log &
#merge "\"$input_path/QCD_Pt_20_30_EMEnriched_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1/*.root\""                 $output_path/QCD_Pt_20_30_EMEnriched_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1/merged_frbaby.root                >& logs/merge_fr_qcd18.log &
#merge "\"$input_path/QCD_Pt_30_80_EMEnriched_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1/*.root\""                 $output_path/QCD_Pt_30_80_EMEnriched_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1/merged_frbaby.root                >& logs/merge_fr_qcd19.log &
#merge "\"$input_path/QCD_Pt_80_170_EMEnriched_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1/*.root\""               $output_path/QCD_Pt_80_170_EMEnriched_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1/merged_frbaby.root                >& logs/merge_fr_qcd20.log &
#
...
#merge "\"$input_path/TT_CT10_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v2/*.root\"" $output_path/TT_CT10_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v2/merged_frbaby.root >& logs/merge_fr_tt_powheg.log &
#merge "\"$input_path/TT_CT10_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v2/*.root\"" $output_path/TT_CT10_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v2/merged_frbaby.root >& logs/merge_fr_tt_powheg2.log &
...
#merge "\"$input_path/TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19_ext1-v1/*.root\"" $output_path/TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19_ext1-v1/merged_frbaby.root >& logs/merge_fr_ttjets_semi1.log &
#merge "\"$input_path/TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19_ext2-v1/*.root\"" $output_path/TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19_ext2-v1/merged_frbaby.root >& logs/merge_fr_ttjets_semi2.log &
