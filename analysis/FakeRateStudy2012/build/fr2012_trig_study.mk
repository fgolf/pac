# ----------------------------------------------------------------------- #
# Makefile for fr2012_trig_study.exe 
# ----------------------------------------------------------------------- #
...
# source files
programs        := fr2012_trig_study.exe
program_dir_rel := analysis/FakeRateStudy2012
sources         := fr2012_trig_study.cc \
				   FakeRateTrigStudy.cc
