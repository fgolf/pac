...
namespace tp
{
    ...
    Selection::value_type GetSelectionFromString(const std::string& sel_name)
    {
        ...
        if (rt::string_lower(sel_name) == "samesigndenid"  ) {return Selection::SameSignElDenID;  } 
        if (rt::string_lower(sel_name) == "samesigndeniso" ) {return Selection::SameSignElDenIso; } 
        if (rt::string_lower(sel_name) == "samesigndenboth") {return Selection::SameSignElDenBoth;} 
        if (rt::string_lower(sel_name) == "samesignnum"    ) {return Selection::SameSignElNum;    } 
