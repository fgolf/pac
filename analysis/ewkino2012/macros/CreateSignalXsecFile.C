...
void CreateSignalXsecFile()
{
    ...
    ewkino::SignalBinInfo bin_info = ewkino::GetSignalBinInfo(at::Sample::sbottomtop);
    ...
    bin_info = ewkino::GetSignalBinInfo(at::Sample::t6ttww_x05);
    ...
    bin_info = ewkino::GetSignalBinInfo(at::Sample::t6ttww_x08);
...
/*     bin_info = ewkino::GetSignalBinInfo(at::Sample::t1tttt); */
    ...
    // --------------------------------------------------------------------------------- //
    // https://twiki.cern.ch/twiki/bin/view/LHCPhysics/SUSYCrossSections8TeVgluglu
    bin_info = ewkino::GetSignalBinInfo(at::Sample::t1tttt_scans);
    ...
    // --------------------------------------------------------------------------------- //
    // https://twiki.cern.ch/twiki/bin/view/LHCPhysics/SUSYCrossSections8TeVgluglu
    bin_info = ewkino::GetSignalBinInfo(at::Sample::t5tttt);
    ...
    // --------------------------------------------------------------------------------- //
    // https://twiki.cern.ch/twiki/bin/view/LHCPhysics/SUSYCrossSections8TeVgluglu
    bin_info = ewkino::GetSignalBinInfo(at::Sample::t5lnu);
    ...
    // TChiwh (chargino-neutralino production -- TChiwz)
    //https://twiki.cern.ch/twiki/bin/view/LHCPhysics/SUSYCrossSections8TeVcharginoneutralinoCMS
    // --------------------------------------------------------------------------------- //

    bin_info = ewkino::GetSignalBinInfo(at::Sample::tchiwh);
    hc.Add(new TH1F ("h_xsec_tchiwh", "Cross Section TChiwh;m_{#tilde{chi^{pm}}} (GeV); Cross Section (pb)", bin_info.nbinsx, &bin_info.xbins[0]));
    SetBinContent(hc["h_xsec_tchiwh"], 130, 4.12e+00, 2.55e-01);
    SetBinContent(hc["h_xsec_tchiwh"], 150, 2.39e+00, 1.26e-01); 
    SetBinContent(hc["h_xsec_tchiwh"], 175, 1.32e+00, 6.72e-02); 
    SetBinContent(hc["h_xsec_tchiwh"], 200, 7.85e-01, 3.73e-02); 
    SetBinContent(hc["h_xsec_tchiwh"], 225, 4.91e-01, 2.14e-02); 
    SetBinContent(hc["h_xsec_tchiwh"], 250, 3.18e-01, 1.42e-02); 
    SetBinContent(hc["h_xsec_tchiwh"], 275, 2.13e-01, 9.15e-03); 
    SetBinContent(hc["h_xsec_tchiwh"], 300, 1.46e-01, 6.61e-03); 
    SetBinContent(hc["h_xsec_tchiwh"], 325, 1.02e-01, 4.36e-03); 
    SetBinContent(hc["h_xsec_tchiwh"], 350, 7.37e-02, 3.13e-03); 
    SetBinContent(hc["h_xsec_tchiwh"], 375, 5.41e-02, 2.28e-03); 
    SetBinContent(hc["h_xsec_tchiwh"], 400, 3.93e-02, 1.67e-03); 
    SetBinContent(hc["h_xsec_tchiwh"], 425, 2.96e-02, 1.31e-03); 
    SetBinContent(hc["h_xsec_tchiwh"], 450, 2.18e-02, 1.01e-03); 
    SetBinContent(hc["h_xsec_tchiwh"], 475, 1.67e-02, 7.91e-04); 
    SetBinContent(hc["h_xsec_tchiwh"], 500, 1.25e-02, 6.27e-04); 
