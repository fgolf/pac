...
./scripts/ewkino2012_plot_all.py --sr $sr --anal_type ss --out_name $out_name --lumi $lumi ${options} --hybrid --print_evt_list --categorize_rare --signal tchiwh-130-1 --print_evt_list --suffix all >& logs/yields_${out_name}_incl_ss.log &
