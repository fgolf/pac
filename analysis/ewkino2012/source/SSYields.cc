...
namespace ewkino_ss
{
    ...
    )
    {
        ...
        {
            throw std::invalid_argument(Form("[ewkino::GetYield] invalid option %s", option.c_str()));
        }
    }
...
ewkino_ss::Yield operator-(const ewkino_ss::Yield& y1, const ewkino_ss::Yield& y2)
{
    using namespace ewkino_ss;
