...
void SameSignTree::SetBranches(TTree &tree)
{
    ...
    tree.Branch("nlbtags_pv"                   , &nlbtags_pv                   , "nlbtags_pv/I"                   ); 
    tree.Branch("nmbtags_pv"                   , &nmbtags_pv                   , "nmbtags_pv/I"                   ); 
    tree.Branch("ntbtags_pv"                   , &ntbtags_pv                   , "ntbtags_pv/I"                   ); 
    tree.Branch("ttbar_bkdn"                   , &ttbar_bkdn                   , "ttbar_bkdn/I"                   ); 
    tree.Branch("vtxw"                         , &vtxw                         , "vtxw/F"                         ); 
    tree.Branch("mt"                           , &mt                           , "mt/F"                           );
    tree.Branch("max_mt"                       , &max_mt                       , "max_mt/F"                       );
    tree.Branch("max_mt_up"                    , &max_mt_up                    , "max_mt_up/F"                    ); 
    tree.Branch("max_mt_dn"                    , &max_mt_dn                    , "max_mt_dn/F"                    ); 
    tree.Branch("max_mt_jer"                   , &max_mt_jer                   , "max_mt_jer/F"                   ); 
