...
float TagAndProbeScaleFactor(int id, float pt, float eta)
{
    ...
    if (abs(id)==11) 
    {
        ...
        {
            cout << "[ewkino::TagAndProbeScaleFactor] WARNING -> eta is in the transition region. returning bogus value -999999" << endl;
            cout << Form("[ewkino::TagAndProbeScaleFactor] id: %d pt: %f eta: %f", id, pt, aeta) << endl; 
            return -999999.0;
        }
        ...
        cout << "[ewkino::TagAndProbeScaleFactor] WARNING -> missed coverage -- returning bogus value -999999" << endl;
        cout << Form("[ewkino::TagAndProbeScaleFactor] id: %d pt: %f eta: %f", id, pt, aeta) << endl; 
        return -999999.0;
    }
