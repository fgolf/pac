...
struct simple_skim
{
    simple_skim(int njets, ewkino::AnalysisType::value_type anal_type) : m_njets(njets), m_at(anal_type) {}
    ...
    int m_njets;
    ewkino::AnalysisType::value_type m_at;
};
...
try
{
    ...
    { 
        ...
        {
            cout << "[ewkino2012_merge_baby] Error: run_list " << run_list << " not found" << endl;
            cout << desc << "\n";
            return 1;
        }
    }
    ...
    // analysis type
    ewkino::AnalysisType::value_type analysis_type = ewkino::GetAnalysisTypeFromName(anal_type);
