...
try
{
    ...
    if (!fake_rate_file_name.empty())
    {
        ...
        {
            cout << "[ewkino2012_ss_analysis] Error: fake rate root file " << fake_rate_file_name << " not found" << endl;
            cout << desc << "\n";
            return 1;
        }
    }
    ...
    {
        cout << "[ewkino2012_ss_analysis] Error: fake rate root file not specified! Exiting..." << endl;
        cout << desc << "\n";
    }
    ...
    {
        cout << "[ewkino2012_ss_anlaysis] Error: fake rate root file not specified! Exiting..." << endl;
        cout << desc << "\n";
    }
    ...
    ewkino::AnalysisType::value_type analysis_type = ewkino::GetAnalysisTypeFromName(analysis_type_name); 
