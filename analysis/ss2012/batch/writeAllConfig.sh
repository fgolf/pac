...
CMS2TAG=V05-03-28
CAMPAIGN=StoreResults-PU_START52_V9_FastSim
./writeConfig.sh sbottomtop "$ATYPE" "$RUNLIST" "$OPTIONS" "$NTUPLE_PATH/SMS-T1tttt_Mgluino-350to2000_mLSP-0to1650_8TeV-Pythia6Z_${CAMPAIGN}-v1/$CMS2TAG/" "$OUTPUT_PATH/SMS-T1tttt_Mgluino-350to2000_mLSP-0to1650_8TeV-Pythia6Z_${CAMPAIGN}-v1"
