...
int AddCMS2Branches(const TString& infname, const TString& outfile, int events, Float_t xsec, Float_t kfactor, Float_t filt_eff, bool SortBasketsByEntry = false) 
{
    ...
    Float_t scale1fb = (events > 0 ? xsec*kfactor*1000*filt_eff/(Float_t)events : -999999.0);
