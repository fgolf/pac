#ifndef FRCLOSURELOOPERETH_HPP
#define FRCLOSURELOOPERETH_HPP
...
class FRClosureLooperETH : public at::AnalysisWithHist
{
public:
    // construct:
    FRClosureLooperETH
    (
        ...
        ss::AnalysisType::value_type analysis_type = ss::AnalysisType::high_pt_eth,
