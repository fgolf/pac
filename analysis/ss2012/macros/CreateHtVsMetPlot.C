...
)
{
    ...
    /*     const ss::SignalRegionType::value_type srt = ss::GetSignalRegionTypeFromName("exclusive"); */
    ...
    const ss::SignalRegionInfo sr_info         = ss::GetSignalRegionInfo(signal_region_name, analysis_type_name, "exclusive");
...
/*     const std::string cms_title = Form("CMS, #sqrt{s} = 8 TeV, L_{int} = %2.1f fb^{-1};H_{T} (GeV); E_{T}^{miss} (GeV)", lumi); */
    ...
    TH2F* h2_ht_vs_pfmet_baseline_njlt4_ee = new TH2F("h2_ht_vs_pfmet_baseline_njlt4_ee", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_njge4_mm = new TH2F("h2_ht_vs_pfmet_baseline_njge4_mm", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_njge4_em = new TH2F("h2_ht_vs_pfmet_baseline_njge4_em", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_njge4_ee = new TH2F("h2_ht_vs_pfmet_baseline_njge4_ee", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);

    TH2F* h2_ht_vs_pfmet_baseline_njlt4_nb0 = new TH2F("h2_ht_vs_pfmet_baseline_njlt4_nb0", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_njlt4_nb1 = new TH2F("h2_ht_vs_pfmet_baseline_njlt4_nb1", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_njlt4_nb2 = new TH2F("h2_ht_vs_pfmet_baseline_njlt4_nb2", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_njge4_nb0 = new TH2F("h2_ht_vs_pfmet_baseline_njge4_nb0", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_njge4_nb1 = new TH2F("h2_ht_vs_pfmet_baseline_njge4_nb1", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_njge4_nb2 = new TH2F("h2_ht_vs_pfmet_baseline_njge4_nb2", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);

    TH2F* h2_ht_vs_pfmet_baseline_nb0_mm = new TH2F("h2_ht_vs_pfmet_baseline_nb0_mm", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_nb0_em = new TH2F("h2_ht_vs_pfmet_baseline_nb0_em", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_nb0_ee = new TH2F("h2_ht_vs_pfmet_baseline_nb0_ee", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_nb1_mm = new TH2F("h2_ht_vs_pfmet_baseline_nb1_mm", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_nb1_em = new TH2F("h2_ht_vs_pfmet_baseline_nb1_em", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_nb1_ee = new TH2F("h2_ht_vs_pfmet_baseline_nb1_ee", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_nb2_mm = new TH2F("h2_ht_vs_pfmet_baseline_nb2_mm", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_nb2_em = new TH2F("h2_ht_vs_pfmet_baseline_nb2_em", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    TH2F* h2_ht_vs_pfmet_baseline_nb2_ee = new TH2F("h2_ht_vs_pfmet_baseline_nb2_ee", cms_title.c_str(), 1500, 0, 1500, 600, 0, 600);
    ...
    TH2F* h2_ht_vs_pfmet_baseline_nb0 = dynamic_cast<TH2F*>(rt::AddHists(h2_ht_vs_pfmet_baseline_nb0_mm, h2_ht_vs_pfmet_baseline_nb0_em, h2_ht_vs_pfmet_baseline_nb0_ee, "h2_ht_vs_pfmet_baseline_nb0", cms_title));
    TH2F* h2_ht_vs_pfmet_baseline_nb1 = dynamic_cast<TH2F*>(rt::AddHists(h2_ht_vs_pfmet_baseline_nb1_mm, h2_ht_vs_pfmet_baseline_nb1_em, h2_ht_vs_pfmet_baseline_nb1_ee, "h2_ht_vs_pfmet_baseline_nb1", cms_title));
    TH2F* h2_ht_vs_pfmet_baseline_nb2 = dynamic_cast<TH2F*>(rt::AddHists(h2_ht_vs_pfmet_baseline_nb2_mm, h2_ht_vs_pfmet_baseline_nb2_em, h2_ht_vs_pfmet_baseline_nb2_ee, "h2_ht_vs_pfmet_baseline_nb2", cms_title));
    ...
    if (!suffix.empty())
    {
        c1->Print(Form("plots/%s/%s/%s/HtVsMET_%s_%s_njs.%s"   , output_path.c_str(), at_info.name.c_str(), "exclusive", at_info.short_name.c_str(), sr_info.name.c_str(), suffix.c_str()));
        c2->Print(Form("plots/%s/%s/%s/HtVsMET_%s_%s_nbs_v1.%s", output_path.c_str(), at_info.name.c_str(), "exclusive", at_info.short_name.c_str(), sr_info.name.c_str(), suffix.c_str()));
        c3->Print(Form("plots/%s/%s/%s/HtVsMET_%s_%s_nbs_v2.%s", output_path.c_str(), at_info.name.c_str(), "exclusive", at_info.short_name.c_str(), sr_info.name.c_str(), suffix.c_str()));
        c4->Print(Form("plots/%s/%s/%s/HtVsMET_%s_%s_nbs_v3.%s", output_path.c_str(), at_info.name.c_str(), "exclusive", at_info.short_name.c_str(), sr_info.name.c_str(), suffix.c_str()));
    }
}
