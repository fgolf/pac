    ...
    )
{
    ...
    p["p_nbtags"      ] = CreateOverlay(vhc_signals, vsignals, vhc_bkgds, vbkgds, "nbtags"     , Form("%s;number of b-tagged jets;Events"  , title.c_str()), "sb::off dt::stack lg::right");
    ...
    p["p_drlepb"      ] = CreateOverlay(vhc_signals, vsignals, vhc_bkgds, vbkgds, "drlepb"     , Form("%s;#DeltaR(lep, btag);Events"       , title.c_str()), "sb::off dt::stack lg::right");
    p["p_btagdr"      ] = CreateOverlay(vhc_signals, vsignals, vhc_bkgds, vbkgds, "btagdr"     , Form("%s;#DeltaR(btag1, btag2);Events"    , title.c_str()), "sb::off dt::stack lg::right");
    p["p_drjetb"      ] = CreateOverlay(vhc_signals, vsignals, vhc_bkgds, vbkgds, "drjetb"     , Form("%s;#DeltaR(btag, jet);Events"       , title.c_str()), "sb::off dt::stack lg::right");
    ...
    p["p_dilep_mass_nj0"] = CreateOverlay(vhc_signals, vsignals, vhc_bkgds, vbkgds, "dilep_mass_nj0" , Form("%s;m_{ll} (GeV);Events"             , title.c_str()), "sb::off dt::stack lg::right");
    p["p_dilep_mass_nj1"] = CreateOverlay(vhc_signals, vsignals, vhc_bkgds, vbkgds, "dilep_mass_nj1" , Form("%s;m_{ll} (GeV);Events"             , title.c_str()), "sb::off dt::stack lg::right");
    p["p_dilep_mass_nj2"] = CreateOverlay(vhc_signals, vsignals, vhc_bkgds, vbkgds, "dilep_mass_nj2" , Form("%s;m_{ll} (GeV);Events"             , title.c_str()), "sb::off dt::stack lg::right");
    ...
    for (size_t i = 1; i != at::DileptonHypType::static_size; i++)
    {
        ...
        p["p_nbtags"    +hn] = CreateOverlay(vhc_signals, vsignals, vhc_bkgds, vbkgds, "nbtags"    +hn , Form("%s;number of b-tagged jets;Events"  , title.c_str()), "sb::off dt::stack lg::right");
        p["p_njets"     +hn] = CreateOverlay(vhc_signals, vsignals, vhc_bkgds, vbkgds, "njets"     +hn , Form("%s;number of jets;Events"           , title.c_str()), "sb::off dt::stack lg::right");
