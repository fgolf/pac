...
void SSTop()
{
    ...
    PrintSystematics("plots/interp/sstop_mg.root", 30, scale);
    PrintSystematics("plots/interp/sstop_mg.root", 31, scale);
    PrintSystematics("plots/interp/sstop_mg.root", 34, scale);
    PrintSystematics("plots/interp/sstop_mg.root", 35, scale);
}
...
void SSTop_powheg2()
{
    ...
    PrintSystematics("plots/interp/sstop_powheg2.root", 31, scale);
    PrintSystematics("plots/interp/sstop_powheg2.root", 34, scale);
    PrintSystematics("plots/interp/sstop_powheg2.root", 35, scale);
}
