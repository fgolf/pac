...
version=21Jan2014absonlyisoFOpt # --FOpt true --invert_iso_only true
nev=-1
...
ss2012_create_fakerate --nev $nev --sample data --channel mu --root_file_name muons_data_${version}.root     --run_list $run_list --FOpt true --invert_iso_only true
...
ss2012_create_fakerate --nev $nev --sample dy --channel mu --root_file_name muons_dy_${version}.root     --run_list $run_list --FOpt true --invert_iso_only true
...
ss2012_create_fakerate --nev $nev --sample wjets --channel mu --root_file_name muons_wjets_${version}.root     --run_list $run_list --FOpt true --invert_iso_only true
...
ss2012_create_fakerate --nev $nev --sample qcd --channel mu --root_file_name muons_qcd_${version}.root     --run_list $run_list --FOpt true --invert_iso_only true
