...
ss2012_create_fakerate_eth.exe --nev -1 --sample data_el --channel el --root_file_name electrons_${tag}.root --run_list $run_list
ss2012_create_fakerate_eth.exe --nev -1 --sample data_mu --channel mu --root_file_name muons_${tag}.root     --run_list $run_list
