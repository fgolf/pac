...
# run data
run_list=json/fullJSON_SUSYFakes.txt
#ss2012_create_fakerate --nev $nev --sample data --channel el --root_file_name electrons_data_${version}.root --run_list $run_list 
ss2012_create_fakerate --nev $nev --sample synch --channel mu --root_file_name muons_data_${version}.root     --run_list $run_list --mu_iso 1.0 --tight_ip false
...
ss2012_create_fakerate --nev $nev --sample dy --channel mu --root_file_name muons_dy_${version}.root     --run_list $run_list --mu_iso 1.0 --tight_ip false
...
ss2012_create_fakerate --nev $nev --sample wjets --channel mu --root_file_name muons_wjets_${version}.root     --run_list $run_list --mu_iso 1.0 --tight_ip false
...
ss2012_create_fakerate --nev $nev --sample qcd --channel mu --root_file_name muons_qcd_${version}.root     --run_list $run_list --mu_iso 1.0 --tight_ip false
...
hadd plots/fake_rates/${version}/ssFR_qcdwjetsdy_standard_${version}.root plots/fake_rates/muons_qcd_${version}/muons_qcd_${version}.root plots/fake_rates/muons_wjets_${version}/muons_wjets_${version}.root plots/fake_rates/muons_dy_${version}/muons_dy_${version}.root
...
cmd="ss2012_make_fr_from_hists --in_data plots/fake_rates/${version}/ssFR_data_standard_${version}.root \
 ...
 --in_fullmc plots/fake_rates/${version}/ssFR_qcdwjetsdy_standard_${version}.root \
 --ele_lumi 0.049 --mu_lumi 0.0081 \
