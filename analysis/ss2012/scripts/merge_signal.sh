...
function post_process2
{
    ...
    local sample=$2
    local input_files=$3
    cmd="ss2012_postprocess_signal_baby --sample $sample --input \"${input_files}\" --output \"${output_path}/${sample}.root\""
    echo $cmd
    #echo $cmd > logs/${tag}/${sample}_${tag}_baby_merge.log 2>&1 &
    #eval $cmd >> logs/${tag}/${sample}_${tag}_baby_merge.log 2>&1 &
}
...
input_files=",${input_files}/SMS-MadGraph_Pythia6Zstar_8TeV_T1tttt_2J_mGo-1100to1400_mLSP-25to500_50GeVX50GeV_Binning_Summer12-START52_V9_FSIM-v2/res/*.root"
input_files=",${input_files}/SMS-MadGraph_Pythia6Zstar_8TeV_T1tttt_2J_mGo-1100to1400_mLSP-525to1000_25GeVX25GeV_Binning_Summer12-START52_V9_FSIM-v2/res/*.root"
input_files=",${input_files}/SMS-MadGraph_Pythia6Zstar_8TeV_T1tttt_2J_mGo-400to750_mLSP-1_50GeVX50GeV_Binning_Summer12-START52_V9_FSIM-v1/res/*.root"
input_files=",${input_files}/SMS-MadGraph_Pythia6Zstar_8TeV_T1tttt_2J_mGo-400to750_mLSP-25to550_50GeVX50GeV_Binning_Summer12-START52_V9_FSIM-v1/res/*.root"
input_files=",${input_files}/SMS-MadGraph_Pythia6Zstar_8TeV_T1tttt_2J_mGo-775to1075_mLSP-25to500_50GeVX50GeV_Binning_Summer12-START52_V9_FSIM-v1/res/*.root"
input_files=",${input_files}/SMS-MadGraph_Pythia6Zstar_8TeV_T1tttt_2J_mGo-775to1075_mLSP-525to875_50GeVX50GeV_Binning_Summer12-START52_V9_FSIM-v2/res/*.root"
input_files=",${input_files}/SMS-MadGraph_Pythia6Zstar_8TeV_T1tttt_2J_mGo-800to1400_mLSP-1_50GeVX50GeV_Binning_Summer12-START52_V9_FSIM-v2/res/*.root"
post_process vlow_pt t1tttt_scan "${input_files}"
