...
void SameSignTree::Reset()
{
    ...
    trig_mm_dmu8_m8_pfnopuht225              = false;
    trig_mm_dreliso1p0mu5_m8_pfnopuht175     = false;
    trig_mm_dreliso1p0mu5_m8_pfnopuht225     = false;
    trig_mm_dmu8_m8_pfht175                  = false;
    trig_mm_dmu8_m8_pfht225                  = false;
    trig_mm_dreliso1p0mu5_m8_pfht175         = false;
    trig_mm_dreliso1p0mu5_m8_pfht225         = false;
    trig_ee_el17_el8_id_iso                  = false;
    trig_ee_del8_id_m8_pfnopuht175           = false;
    trig_ee_del8_id_m8_pfnopuht225           = false;
    trig_ee_del8_id_m8_pfht175               = false;
    trig_ee_del8_id_m8_pfht225               = false;
    trig_ee_del14_id_m8_pfmet40              = false;
    trig_ee_del14_id_m8_pfmet50              = false;
    trig_em_mu17_el8_id_iso                  = false;
    trig_em_mu8_el17_id_iso                  = false;
    trig_em_mu14_el14_id_m8_pfmet40          = false;
    trig_em_mu14_el14_id_m8_pfmet50          = false;
    trig_em_mu8_el8_id_m8_pfnopuht175        = false;
    trig_em_mu8_el8_id_m8_pfnopuht225        = false;
    trig_em_riso1p0mu5_el8_id_m8_pfnopuht175 = false;
    trig_em_riso1p0mu5_el8_id_m8_pfnopuht225 = false;
    trig_em_mu8_el8_id_m8_pfht175            = false;
    trig_em_mu8_el8_id_m8_pfht225            = false;
    trig_em_riso1p0mu5_el8_id_m8_pfht175     = false;
    trig_em_riso1p0mu5_el8_id_m8_pfht225     = false;
    trig_mm_met                              = false;
    trig_mm_ht                               = false;
    trig_mm_iso_ht                           = false;
    trig_ee_noiso_met                        = false;
    trig_ee_noiso_ht                         = false;
    trig_em_met                              = false;
    trig_em_ht                               = false;
...
void SameSignTree::SetBranches(TTree &tree)
{
    ...
    tree.Branch("trig_mm_dmu8_m8_pfnopuht225"              , &trig_mm_dmu8_m8_pfnopuht225              , "trig_mm_dmu8_m8_pfnopuht225/O"              ); 
    ...
    tree.Branch("trig_mm_dreliso1p0mu5_m8_pfnopuht225"     , &trig_mm_dreliso1p0mu5_m8_pfnopuht225     , "trig_mm_dreliso1p0mu5_m8_pfnopuht225/O"     ); 
    tree.Branch("trig_mm_dmu8_m8_pfht175"                  , &trig_mm_dmu8_m8_pfht175                  , "trig_mm_dmu8_m8_pfht175/O"                  ); 
    tree.Branch("trig_mm_dmu8_m8_pfht225"                  , &trig_mm_dmu8_m8_pfht225                  , "trig_mm_dmu8_m8_pfht225/O"                  ); 
    tree.Branch("trig_mm_dreliso1p0mu5_m8_pfht175"         , &trig_mm_dreliso1p0mu5_m8_pfht175         , "trig_mm_dreliso1p0mu5_m8_pfht175/O"         ); 
    tree.Branch("trig_mm_dreliso1p0mu5_m8_pfht225"         , &trig_mm_dreliso1p0mu5_m8_pfht225         , "trig_mm_dreliso1p0mu5_m8_pfht225/O"         ); 
    ...
    tree.Branch("trig_ee_del8_id_m8_pfnopuht225"           , &trig_ee_del8_id_m8_pfnopuht225           , "trig_ee_del8_id_m8_pfnopuht225/O"           ); 
    tree.Branch("trig_ee_del8_id_m8_pfht175"               , &trig_ee_del8_id_m8_pfht175               , "trig_ee_del8_id_m8_pfht175/O"               ); 
    tree.Branch("trig_ee_del8_id_m8_pfht225"               , &trig_ee_del8_id_m8_pfht225               , "trig_ee_del8_id_m8_pfht225/O"               ); 
    tree.Branch("trig_ee_del14_id_m8_pfmet40"              , &trig_ee_del14_id_m8_pfmet40              , "trig_ee_del14_id_m8_pfmet40/O"              ); 
    tree.Branch("trig_ee_del14_id_m8_pfmet50"              , &trig_ee_del14_id_m8_pfmet50              , "trig_ee_del14_id_m8_pfmet50/O"              ); 
    ...
    tree.Branch("trig_em_mu14_el14_id_m8_pfmet40"          , &trig_em_mu14_el14_id_m8_pfmet40          , "trig_em_mu14_el14_id_m8_pfmet40/O"          ); 
    tree.Branch("trig_em_mu14_el14_id_m8_pfmet50"          , &trig_em_mu14_el14_id_m8_pfmet50          , "trig_em_mu14_el14_id_m8_pfmet50/O"          ); 
    tree.Branch("trig_em_mu8_el8_id_m8_pfnopuht175"        , &trig_em_mu8_el8_id_m8_pfnopuht175        , "trig_em_mu8_el8_id_m8_pfnopuht175/O"        ); 
    tree.Branch("trig_em_mu8_el8_id_m8_pfnopuht225"        , &trig_em_mu8_el8_id_m8_pfnopuht225        , "trig_em_mu8_el8_id_m8_pfnopuht225/O"        ); 
    ...
    tree.Branch("trig_em_riso1p0mu5_el8_id_m8_pfnopuht225" , &trig_em_riso1p0mu5_el8_id_m8_pfnopuht225 , "trig_em_riso1p0mu5_el8_id_m8_pfnopuht225/O" ); 
    tree.Branch("trig_em_mu8_el8_id_m8_pfht175"            , &trig_em_mu8_el8_id_m8_pfht175            , "trig_em_mu8_el8_id_m8_pfht175/O"            ); 
    tree.Branch("trig_em_mu8_el8_id_m8_pfht225"            , &trig_em_mu8_el8_id_m8_pfht225            , "trig_em_mu8_el8_id_m8_pfht225/O"            ); 
    ...
    tree.Branch("trig_em_riso1p0mu5_el8_id_m8_pfht225"     , &trig_em_riso1p0mu5_el8_id_m8_pfht225     , "trig_em_riso1p0mu5_el8_id_m8_pfht225/O"     ); 
    tree.Branch("trig_mm_met"                              , &trig_mm_met                              , "trig_mm_met/O"                              ); 
    tree.Branch("trig_mm_ht"                               , &trig_mm_ht                               , "trig_mm_ht/O"                               ); 
    tree.Branch("trig_mm_iso_ht"                           , &trig_mm_iso_ht                           , "trig_mm_iso_ht/O"                           ); 
    tree.Branch("trig_ee_noiso_met"                        , &trig_ee_noiso_met                        , "trig_ee_noiso_met/O"                        ); 
    tree.Branch("trig_ee_noiso_ht"                         , &trig_ee_noiso_ht                         , "trig_ee_noiso_ht/O"                         ); 
