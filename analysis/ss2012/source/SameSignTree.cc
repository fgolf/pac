...
void SameSignTree::SetBranches(TTree &tree)
{
    ...
    tree.Branch("njets_dwn"         , &njets_dwn                  , "njets_dwn/I"        );
    tree.Branch("njets_up"          , &njets_up                   , "njets_up/I"         );
    tree.Branch("nbtags_dwn"        , &nbtags_dwn                 , "nbtags_dwn/I"       );
    tree.Branch("nbtags_up"         , &nbtags_up                  , "nbtags_up/I"        );
    tree.Branch("ht_dwn"            , &ht_dwn                     , "ht_dwn/F"           );
    tree.Branch("ht_up"             , &ht_up                      , "ht_up/F"            );
    tree.Branch("pfmet_dwn"         , &pfmet_dwn                  , "pfmet_dwn/F"        );
