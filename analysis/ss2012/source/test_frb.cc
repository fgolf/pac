...
int main()
{
        // create chain
    TChain chain("Events");
    chain.Add("/nfs-7/userdata/rwkelley/cms2/ttjets_powheg_cms2.root");
    ...
    //chain.Add("/hadoop/cms/store/group/snt/papers2012/Summer12_53X_MC/QCD_Pt_20_MuEnrichedPt_15_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v3/V05-03-18_slim/merged_ntuple_100.root");
    ...
    babymaker.ScanChain(&chain, "output/test_frb.root", /*eormu = */-1, /*apply fo filter =*/true, /*jet corr path = */"/home/users/rwkelley/temp/pac/externals/source/cms2_core/ss2012_V02-05-12/CORE/jetcorr/data");
}
