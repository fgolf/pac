...
void TrileptonZTree::SetBranches(TTree &tree)
{
    ...
    tree.Branch(Form("%slep1_id_bitmask"      , prefix_.c_str()) , &lep1_id_bitmask      , "lep1_id_bitmask/I"        );
    ...
    tree.Branch(Form("%slep2_id_bitmask"      , prefix_.c_str()) , &lep2_id_bitmask      , "lep2_id_bitmask/I"        );
    ...
    tree.Branch(Form("%slep3_id_bitmask"      , prefix_.c_str()) , &lep3_id_bitmask      , "lep3_id_bitmask/I"        );
