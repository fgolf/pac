...
namespace rt
{
    ...
    {   
        if (!hist_ptr)
        {
            std::cerr << "Warning: rt::Fill() -- hist pointer is NULL! Doing nothing." << std::endl;
            return;
        }
        x = std::min(hist_ptr->GetXaxis()->GetBinCenter(hist_ptr->GetXaxis()->GetLast()) , x);
        x = std::max(hist_ptr->GetXaxis()->GetBinCenter(hist_ptr->GetXaxis()->GetFirst()), x);
        hist_ptr->Fill(x, w);
    }   
    ...
    {   
        if (!hist_ptr)
        {
            std::cerr << "Warning: rt::Fill2D() -- hist pointer is NULL! Doing nothing." << std::endl;
            return;
        }
        x = std::min(hist_ptr->GetXaxis()->GetBinCenter(hist_ptr->GetXaxis()->GetLast()) , x);
        x = std::max(hist_ptr->GetXaxis()->GetBinCenter(hist_ptr->GetXaxis()->GetFirst()), x);
        y = std::min(hist_ptr->GetYaxis()->GetBinCenter(hist_ptr->GetYaxis()->GetLast()) , y);
        y = std::max(hist_ptr->GetYaxis()->GetBinCenter(hist_ptr->GetYaxis()->GetFirst()), y);
        hist_ptr->Fill(x, y, w);
    }
    ...
    {   
        ...
        y = std::min(hist_ptr->GetYaxis()->GetBinCenter(hist_ptr->GetYaxis()->GetLast()) , y);
        y = std::max(hist_ptr->GetYaxis()->GetBinCenter(hist_ptr->GetYaxis()->GetFirst()), y);
        z = std::min(hist_ptr->GetZaxis()->GetBinCenter(hist_ptr->GetZaxis()->GetLast()) , z);
        z = std::max(hist_ptr->GetZaxis()->GetBinCenter(hist_ptr->GetZaxis()->GetFirst()), z);
        hist_ptr->Fill(x, y, z, w);
    }
    ...
    {   
        if (!hist_ptr)
        {
            std::cerr << "Warning: rt::Fill3D() -- hist pointer is NULL! Doing nothing." << std::endl;
            return;
        }
